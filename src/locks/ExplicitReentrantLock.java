...
public class ExplicitReentrantLock {
     ...
     *
     *  Для этого служит параметр конструктора fairness.
     *
     *  Если он установлен в true, тогда приоритет доступа к объекту получает тот поток, кото
     *  дольше всех его ожидает.
     *
     *  В противном случае, приоритет доступа к объекту для других потоков никак не гарантируется.
     */
